        ...
        <section className="bg-[#0b1f52] text-white lg:hidden">
          <div className="px-6 pt-8 pb-7">
            ...
            <h1 className="text-3xl font-bold leading-tight text-white">
              50 x 100 residential plots in Kitengela
            </h1>
          ...
          <div className="relative h-[320px] w-full overflow-hidden bg-[#e9edf3]">
            <Image
              src={heroSrc}
              alt="Lush 4 Kitengela residential plots"
              fill
              priority
              quality={90}
              sizes="100vw"
        ...
        <div className="mx-auto max-w-7xl">
          <div className="rounded-[2rem] border border-[#e8eef5] bg-white p-6 shadow-sm sm:p-8 lg:p-10">
            ...
            <p className="mt-6 text-base leading-8 text-gray-600">
              Lush 4 offers affordable residential plots in Kitengela for buyers
              who want land near Nairobi without stretching to city prices. The
              project is designed for people planning to build gradually, settle
              in a growing neighbourhood, or hold a 50 x 100 plot as a long-term
      ...
      <section className="px-6 pb-20 lg:px-12">
        <div className="mx-auto grid max-w-7xl gap-8 lg:grid-cols-3">
          ...
          <InfoCard
            ...
            text="A practical option for first-time buyers, young families, commuters, and investors looking for affordable land near Nairobi."
          />
          <InfoCard
        ...
        <div className="mx-auto grid max-w-7xl items-center gap-10 lg:grid-cols-2">
          <div>
            ...
            <p className="mt-6 text-base leading-8 text-gray-600">
              ...
              opportunity to secure land in a developing neighbourhood where
              settlement and construction are already realistic.
            </p>

            <p className="mt-4 text-base leading-8 text-gray-600">
              For buyers comparing plots for sale in Kitengela, Lush 4 offers a
              useful balance of price, location, documentation, and flexible
              payment terms. It is suitable for first-time land buyers, young
              families planning ahead, and investors looking for residential land
              near Nairobi with long-term demand.
            </p>
          </div>
      ...
      <section className="bg-white px-6 py-20 lg:px-12">
        <div className="mx-auto max-w-7xl">
          ...
          <div className="grid gap-5 md:grid-cols-2 lg:grid-cols-3">
            <FeatureCard text="50 x 100 plots in a growing Kitengela neighbourhood" />
            <FeatureCard text="Road access already in place" />
            <FeatureCard text="Ideal for immediate construction or future settlement" />
        ...
        <div className="mx-auto grid max-w-7xl gap-10 lg:grid-cols-[0.9fr_1.1fr]">
          <div>
            ...
            <p className="mt-5 text-base leading-8 text-gray-600">
              ...
              interest is already set to Lush 4 – Kitengela, and our team can
              guide you on location, price, payment plans, site visits, and title
              deed verification.
            </p>
          </div>
