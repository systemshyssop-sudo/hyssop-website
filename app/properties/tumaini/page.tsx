      ...
      <section className="px-6 pb-20 lg:px-12">
        <div className="mx-auto grid max-w-7xl gap-8 lg:grid-cols-3">
          <InfoCard
            ...
            text="Located in Nakuru, approximately 10 minutes from Nakuru CBD, near Tumaini Resort, RVIST College, and the Nakuru–Njoro corridor."
          />
          <InfoCard
            title="Investment Position"
            text="Designed for buyers seeking a near-urban gated estate with lifestyle appeal and long-term capital appreciation potential."
          />
          <InfoCard
            title="Ownership Confidence"
            text="50 x 100 plots with ready title deeds and flexible installment options for buyers planning to build or invest."
          />
        </div>
      </section>
      ...
      <section className="bg-[#f8fafc] px-6 py-20 lg:px-12">
        <div className="mx-auto grid max-w-7xl items-center gap-10 lg:grid-cols-2">
          <div>
            ...
            <p className="mt-6 text-base leading-8 text-gray-600">
              Tumaini Estate is ideal for homeowners and investors seeking
              proximity, security, and long-term value. It combines urban access
              with the comfort of a controlled, gated environment.
            ...
            <p className="mt-6 text-base leading-8 text-gray-600">
              This gem is positioned for buyers who want more than just land. 
              Whether you’re building a home or securing an appreciating asset, 
              Tumaini offers the flexibility to start now and grow over time 
              through accessible installment options and ready title deeds.
        ...
        <div className="mx-auto grid max-w-7xl gap-10 lg:grid-cols-[0.9fr_1.1fr]">
          <div>
            ...
            <p className="mt-5 text-base leading-8 text-gray-600">
              ...
              of interest is already set to Tumaini Estate – Nakuru.
            </p>
          </div>
